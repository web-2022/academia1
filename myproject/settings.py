...
SECRET_KEY = 'django-insecure-_)7mc#59pvxvs!ws=l-91i(-&zfb#jl3@ej*!$-3aebtd8+)xa'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Ruta donde se almacenarán los archivos media

STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "courses" / "static",  # Asegúrate de que esta ruta sea correcta
]
